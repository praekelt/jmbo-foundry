...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Listing.modified'
        db.add_column('foundry_listing', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 4, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Listing.modified'
        db.delete_column('foundry_listing', 'modified')
