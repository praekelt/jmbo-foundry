...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Column.title'
        db.add_column('foundry_column', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Listing.display_title_tiled'
        db.add_column('foundry_listing', 'display_title_tiled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Column.title'
        db.delete_column('foundry_column', 'title')

        # Deleting field 'Listing.display_title_tiled'
