...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Navbar', fields ['slug']
        db.delete_unique('foundry_navbar', ['slug'])

        # Removing unique constraint on 'Listing', fields ['slug']
