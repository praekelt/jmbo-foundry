...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Row.class_name'
        db.add_column('foundry_row', 'class_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Column.class_name'
        db.add_column('foundry_column', 'class_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Row.class_name'
        db.delete_column('foundry_row', 'class_name')

        # Deleting field 'Column.class_name'
