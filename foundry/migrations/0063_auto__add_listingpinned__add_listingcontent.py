...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ListingPinned'
        db.create_table(u'foundry_listingpinned', (
        ...
        db.send_create_signal(u'foundry', ['ListingPinned'])

        # Adding model 'ListingContent'
        db.create_table(u'foundry_listingcontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('modelbase_obj', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jmbo.ModelBase'])),
            ('listing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foundry.Listing'])),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'foundry', ['ListingContent'])

        # Migrate data. Manual sql is required.
        if not db.dry_run:
            connection = db._get_connection()
            cursor = connection.cursor()
            for listing in orm.Listing.objects.all():
                cursor.execute('select modelbase_id from %s where listing_id=%s' % (db.shorten_name(u'foundry_listing_content'), listing.pk))
                for tu in cursor.fetchall():
                    orm.ListingContent.objects.create(
                        modelbase_obj_id=tu[0], listing=listing, position=tu[0]
                    )
                cursor.execute('select modelbase_id from %s where listing_id=%s' % (db.shorten_name(u'foundry_listing_pinned'), listing.pk))
                for tu in cursor.fetchall():
                    orm.ListingPinned.objects.create(
                        modelbase_obj_id=tu[0], listing=listing, position=tu[0]
                    )
    ...
    def backwards(self, orm):
        # Deleting model 'ListingPinned'
        db.delete_table(u'foundry_listingpinned')
        ...
        db.create_table(m2m_table_name, (
            ...
            ('listing', models.ForeignKey(orm[u'foundry.listing'], null=False)),
            ('modelbase', models.ForeignKey(orm[u'jmbo.modelbase'], null=False))
        ))
        db.create_unique(m2m_table_name, ['listing_id', 'modelbase_id'])

        # Adding M2M table for field pinned on 'Listing'
        m2m_table_name = db.shorten_name(u'foundry_listing_pinned')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('listing', models.ForeignKey(orm[u'foundry.listing'], null=False)),
            ('modelbase', models.ForeignKey(orm[u'jmbo.modelbase'], null=False))
    ...
    models = {
        ...
        u'foundry.listing': {
            ...
            'content': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'listing_content'", 'to': u"orm['jmbo.ModelBase']", 'through': u"orm['foundry.ListingContent']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            ...
            'pinned': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'listing_pinned'", 'to': u"orm['jmbo.ModelBase']", 'through': u"orm['foundry.ListingPinned']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['sites.Site']", 'null': 'True', 'blank': 'True'}),
        ...
        u'foundry.listingcontent': {
            'Meta': {'object_name': 'ListingContent'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'listing': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['foundry.Listing']"}),
            'modelbase_obj': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['jmbo.ModelBase']"}),
            'position': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
        u'foundry.listingpinned': {
            'Meta': {'object_name': 'ListingPinned'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'listing': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['foundry.Listing']"}),
            'modelbase_obj': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['jmbo.ModelBase']"}),
            'position': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
