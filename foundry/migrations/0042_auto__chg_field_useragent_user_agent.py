...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAgent.user_agent'
        db.alter_column('foundry_useragent', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
        # Adding index on 'UserAgent', fields ['user_agent']
        db.create_index('foundry_useragent', ['user_agent'])


    def backwards(self, orm):
        # Removing index on 'UserAgent', fields ['user_agent']
        db.delete_index('foundry_useragent', ['user_agent'])


        # Changing field 'UserAgent.user_agent'
        db.alter_column('foundry_useragent', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
    ...
    models = {
        ...
        'foundry.useragent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user_agent': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '512', 'null': 'True', 'blank': 'True'})
        },
        'jmbo.modelbase': {
