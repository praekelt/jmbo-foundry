...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Badge', fields ['type']
        db.create_unique('foundry_badge', ['type'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Badge', fields ['type']
        db.delete_unique('foundry_badge', ['type'])
