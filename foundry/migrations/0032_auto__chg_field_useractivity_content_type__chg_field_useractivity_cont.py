...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserActivity.content_type'
        db.alter_column('foundry_useractivity', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

        # Changing field 'UserActivity.content_id'
        db.alter_column('foundry_useractivity', 'content_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'UserActivity.content_type'
        raise RuntimeError("Cannot reverse this migration. 'UserActivity.content_type' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'UserActivity.content_id'
        raise RuntimeError("Cannot reverse this migration. 'UserActivity.content_id' and its values cannot be restored.")
    ...
    models = {
        ...
        'foundry.directmessage': {
            ...
            'reply_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'replies'", 'null': 'True', 'to': "orm['foundry.DirectMessage']"}),
