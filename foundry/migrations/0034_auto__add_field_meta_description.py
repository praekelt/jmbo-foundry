...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('preferences_generalpreferences', 'meta_description', self.gf('django.db.models.fields.TextField')(blank=True, null=True), keep_default=False)


    def backwards(self, orm):
        db.delete_column('preferences_generalpreferences', 'meta_description')
