...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sites on 'Listing'
        ...
        # Adding M2M table for field sites on 'Navbar'
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field sites on 'Listing'
        db.delete_table('foundry_listing_sites')

        # Removing M2M table for field sites on 'Navbar'
