...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DownloadVariation'
        db.create_table('foundry_downloadvariation', (
        ...
        db.send_create_signal('foundry', ['DownloadVariation'])

        # Adding M2M table for field variations on 'Download'
        db.create_table('foundry_download_variations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('download', models.ForeignKey(orm['foundry.download'], null=False)),
            ('downloadvariation', models.ForeignKey(orm['foundry.downloadvariation'], null=False))
        ))
        db.create_unique('foundry_download_variations', ['download_id', 'downloadvariation_id'])


    def backwards(self, orm):
        # Deleting model 'DownloadVariation'
        db.delete_table('foundry_downloadvariation')

        # Removing M2M table for field variations on 'Download'
        db.delete_table('foundry_download_variations')
    ...
    models = {
        ...
        'foundry.download': {
            ...
            'variations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['foundry.DownloadVariation']", 'null': 'True', 'blank': 'True'})
        },
        'foundry.downloadvariation': {
            'Meta': {'ordering': "['points_required']", 'object_name': 'DownloadVariation', '_ormbases': ['jmbo.ModelBase']},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'}),
            'points_required': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'})
        },
