...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FoundryComment.likes_enabled'
        db.add_column('foundry_foundrycomment', 'likes_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'FoundryComment.anonymous_likes'
        db.add_column('foundry_foundrycomment', 'anonymous_likes',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'FoundryComment.likes_closed'
        db.add_column('foundry_foundrycomment', 'likes_closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FoundryComment.likes_enabled'
        db.delete_column('foundry_foundrycomment', 'likes_enabled')

        # Deleting field 'FoundryComment.anonymous_likes'
        db.delete_column('foundry_foundrycomment', 'anonymous_likes')

        # Deleting field 'FoundryComment.likes_closed'
        db.delete_column('foundry_foundrycomment', 'likes_closed')
