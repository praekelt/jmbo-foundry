...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Listing.display_primary_category'
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Listing.display_primary_category'
    ...
    models = {
        ...
        'foundry.listing': {
            ...
            'display_category': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
